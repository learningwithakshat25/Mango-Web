                ...
                <div className="left flex flex-col items-start justify-start gap-5">
                    ...
                    <div className="bottom w-full md:flex md:flex-row relative justify-center md:flex-wrap font-semibold text-lg  gap-14  grid grid-cols-2">
                        <div className="card flex flex-col items-center justify-center gap-4 relative ">
                            ...
                            <h1 className='rounded-md bg-[#568F67] absolute md:top-52 p-2 text-white font-semibolf md:text-md text-sm top-22 text-center '>Alphonso mangoes</h1>
                        </div>
                        <div className="card flex flex-col items-center justify-center gap-4 relative">
                            <img className='md:h-60' src="/mango2.png" alt="" />
                            <h1 className=' rounded-md bg-[#568F67] absolute md:top-52 top-22 p-2 text-white font-semibolf md:text-md text-sm text-center'>Ataulfo mangoes</h1>
                        </div>
                        <div className="card flex flex-col items-center justify-center gap-4 relative">
                            <img className='md:h-60' src="/mango3.png" alt="" />
                            <h1 className=' rounded-md bg-[#568F67] absolute md:top-52 top-22 p-2 text-white font-semibolf md:text-md text-sm text-center'>Keitt mangoes</h1>
                        </div>
                        <div className="card flex flex-col items-center justify-center gap-4 relative">
                            <img className='md:h-60' src="/mango4.png" alt="" />
                            <h1 className=' rounded-md bg-[#568F67] absolute md:top-52 top-22 p-2 text-white font-semibolf md:text-md text-sm text-center'>Tommy Atkins mangoes</h1>
                        </div>
                        <div className="card flex flex-col items-center justifycentert gap-4 relative">
                            <img className='md:h-60' src="/mango5.png" alt="" />
                            <h1 className=' rounded-md bg-[#568F67] absolute md:top-52 top-22 p-2 text-white font-semibolf md:text-md text-sm text-center'>kesar angoes</h1>
                        </div>
                        <div className="card flex flex-col items-center justify-center gap-4 relative">
                            <img className='md:h-60' src="/mango6.png" alt="" />
                            <h1 className=' rounded-md bg-[#568F67] absolute md:top-52 top-22 p-2 text-white font-semibolf md:text-md text-sm text-center'>neelum mangoes</h1>
                        </div>
                    </div>
            </div>
